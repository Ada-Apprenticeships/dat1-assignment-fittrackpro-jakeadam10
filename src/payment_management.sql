...
VALUES (11, 50, datetime('now', 'localtime'), 'Credit Card', 'Monthly membership fee'); */

-- 2. Calculate total revenue from membership fees for each month of the last year
/* SELECT CAST(STRFTIME('%m', payment_date) AS INTEGER) AS payment_month, -- extracts month from payment_date
